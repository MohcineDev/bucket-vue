<template>
    ...
    <section class="wrapper ips">
        <div>
        <textarea name="" id="ips" :value="targetIps" @change="targetIpsChange" placeholder="target ips" cols="30" rows="10"></textarea>
        <span ></span>
        ...
        <div class="controls">
            <div>
                ...
                <input type="number" :value="splitInto" id="splitInto" min="2" max="5">
            </div>
...
const targetIps = ref('12.21.21.12\n12.21.21.12')
...
function targetIpsChange(){
    document.querySelector(' #ips+span').textContent = targetIps.value.split('\n').length    
}
...
.txt_wrapper>textarea, .txt_wrapper div {
    width: 48%;
}
